 ...
 * This file demonstrates how to integrate Orbitforge with a web frontend
 */

// For React/Vue/Angular applications
export class OrbitforgeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OrbitforgeClient(provider, contractAddress);
